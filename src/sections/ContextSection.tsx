...
export default function ContextSection() {
  ...
  return (
    <section id="stats" className="mx-auto max-w-screen-lg px-4 p-10 mt-10">
      <div ref={headerRef} className={`flex flex-col sm:flex-row sm:items-center gap-4 mb-12 transition-all duration-700 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
        {/* Highlight Card */}
        <div ref={highlightRef} className={`col-span-1 md:col-span-4 bg-amber-600 text-white p-6 sm:p-8 rounded-3xl shadow-xl flex flex-col justify-center relative overflow-hidden min-h-[280px] sm:min-h-auto transition-all duration-800 ease-out ${highlightVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
        ...
        {/* Data Grid */}
        <div ref={cardsRef} className="col-span-1 md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <div className={`bg-white p-4 sm:p-6 rounded-2xl border border-stone-200 hover:border-amber-400 transition-all shadow-sm flex flex-col items-center justify-center min-h-[200px] sm:min-h-auto duration-700 ease-out ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: cardsVisible ? '0.1s' : '0s' }}>        
          ...
          <div className={`bg-white p-4 sm:p-6 rounded-2xl border border-stone-200 hover:border-amber-400 transition-all shadow-sm flex flex-col items-center justify-center min-h-[200px] sm:min-h-auto duration-700 ease-out ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: cardsVisible ? '0.2s' : '0s' }}>
            <div className="w-full text-left">
          ...
          <div className={`bg-white p-4 sm:p-6 rounded-2xl border border-stone-200 hover:border-amber-400 transition-all shadow-sm flex flex-col items-center justify-center min-h-[200px] sm:min-h-auto duration-700 ease-out ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: cardsVisible ? '0.3s' : '0s' }}>
            <div className="w-full text-left">
          ...
          <div className={`bg-white p-4 sm:p-6 rounded-2xl border border-stone-200 hover:border-amber-400 transition-all shadow-sm flex flex-col items-center justify-center min-h-[200px] sm:min-h-auto duration-700 ease-out ${cardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: cardsVisible ? '0.4s' : '0s' }}>
            <div className="w-full text-left">
