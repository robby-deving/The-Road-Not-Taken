...
export default function AuthorSection() {
  ...
  <div className="mx-auto max-w-screen-lg px-4 p-10 mt-10">
    ...
    <div className="mt-10 shadow-lg rounded-2xl overflow-hidden">
        <div className="bg-[#1C1917] rounded-t-2xl flex flex-col lg:flex-row gap-8 lg:gap-20 ">
            <div className="flex flex-col flex-1 p-5 md:p-10">
                <div className="text-white alegreya-semibold text-2xl md:text-4xl">Robert Lee Frost</div>
                <div className="flex flex-wrap gap-3 mt-3">
                    <div className="flex items-center gap-2 md:gap-3 text-white bg-[#292524] rounded-2xl px-2 md:px-3 py-1 w-fit alegreya-regular text-xs md:text-base">
                ...
                <div className="bg-[#292524] border border-[#D76D01] rounded-2xl p-4 md:p-5 font-medium text-[11px] md:text-[12px] text-white mt-5 flex flex-col gap-3">
